...
This vignette demonstrates a complete workflow for using the **BCFM** (Bayesian Clustering Factor Model) package. We'll use a simulated dataset that comes with the package to illustrate:
